...
folder = 'C:/Users/aero_waas_2018_1/Documents/GitHub/composite-multiscale/micro_ruc/prepare_RUC_model/5_Manipulating_input_files'
odbname = 'RUC_multi_strain_original_parametric'

odb = session.odbs[folder + '/' + odbname + '.odb']
