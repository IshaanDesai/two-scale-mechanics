...
class MicroSimulation:
    ...
    def __init__(self, sim_id):
        ...
        os.chdir('/home/desaii/composite-multiscale/micro_abaqus/restart_method')
    ...
    def solve(self, strains, dt):
        ...
        os.chdir('/home/desaii/composite-multiscale/micro_abaqus/restart_method/' + self._foldername)
