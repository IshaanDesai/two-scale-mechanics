...
#
# Job name:
#SBATCH -J scale-meso-bar2-sphere32-node
#
...
edit::meso_input_switch ./config-meso.json "${OUT_DIR}/meso-geom" "${OUT_DIR}/meso-state" "${JOB_DIR}/precice-config.xml" "examples/coupled-bar/bar2.msh"
