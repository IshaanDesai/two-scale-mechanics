...
#
# Job name:
#SBATCH -J scale-mm128worker1-notch-voro32
#
...
edit::meso_input_switch ./config-meso.json "${OUT_DIR}/meso-geom" "${OUT_DIR}/meso-state" "${JOB_DIR}/precice-config.xml" "examples/coupled-notch/notch.msh"
