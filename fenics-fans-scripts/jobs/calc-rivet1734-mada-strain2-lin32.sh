...
#
# Job name:
#SBATCH -J calc-rivet1734-mada-strain2-lin32
#
...
cp $MICRO_PATH/mada_switcher_strain2.py ./mada_switcher.py
...
edit::fans_input_switch ./input1.json ${NUM_MM_WORKERS} "sphere3p32.h5"
